...
#    BUILD_TARGETS=`bazel query //modules/... union //cyber/...`
    ...
    BUILD_TARGETS=`bazel query //modules/... union //cyber/... except //modules/data/tools/rosbag_to_record/...  except //modules/v2x/... except //modules/map/tools/map_datachecker/... $DISABLE_CYBER_MODULES`
  esac
...
#  "
  BUILD_TARGETS=`bazel query //modules/... union //cyber/... except //modules/data/tools/rosbag_to_record/...  except //modules/v2x/... except //modules/drivers/video/tools/decode_video/... except //modules/map/tools/map_datachecker/... `
